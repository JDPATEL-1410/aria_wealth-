        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-white rounded-xl shadow-xl border-2 border-gray-100 p-3 sm:p-4 text-center">
              ...
              <p className="text-sm sm:text-lg font-bold text-gray-900">{formatCurrency(results.investment)}</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-xl border-2 border-gray-100 p-3 sm:p-4 text-center">
              ...
              <p className="text-sm sm:text-lg font-bold text-green-600">{formatCurrency(results.totalReturns)}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#7A1616] to-[#8B1A1A] rounded-xl shadow-xl p-3 sm:p-4 text-center text-white">
              ...
              <p className="text-sm sm:text-lg font-bold text-white">{formatCurrency(results.futureValue)}</p>
            </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                {[8, 12, 15].map((rate) => {
                  ...
                  return (
                    <div key={rate} className={`p-3 sm:p-4 rounded-lg border-2 ${
                      rate === expectedReturn 
                      ...
                      <div className="text-center">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-base sm:text-xl font-bold text-[#7A1616]">{formatCurrency(futureValue)}</p>
                          <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">Returns</p>
                          <p className="text-sm sm:text-lg font-semibold text-green-600">{formatCurrency(returns)}</p>
                        </div>
                      </div>
                    </div>
                  );
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
                    <div className="text-xs sm:text-sm text-gray-600 mb-2">Investment: {formatCurrency(investment)}</div>
                    <div className="text-base sm:text-lg font-bold text-blue-600">
                      {formatCurrency(investment * Math.pow(1.08, timePeriod))}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600">
                      Returns: {formatCurrency(investment * Math.pow(1.08, timePeriod) - investment)}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
                    ...
                    <div className="text-base sm:text-lg font-bold text-green-600">
                      {formatCurrency(investment * Math.pow(1.15, timePeriod))}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600">
                      Returns: {formatCurrency(investment * Math.pow(1.15, timePeriod) - investment)}
                    </div>
                  </div>
                </div>
              </div>
