...
import { Baby, TrendingUp, Target, Info, Calendar, Heart, ShoppingBag } from 'lucide-react';
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center sm:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-extrabold text-blue-600">
                    {formatCurrency(results.totalCurrentCost, selectedCurrency)}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={results.projectionData}>
                    ...
                    />
                    <Tooltip
                      formatter={(value, name) => [formatCurrency(value, selectedCurrency), name === 'savings' ? 'Your Savings' : 'Target Cost']}
